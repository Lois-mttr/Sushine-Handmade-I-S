...
class InformeService:
    ...
    def obtener_metricas_dashboard():
        ...
        with connection.cursor() as cursor:
            InformeService._agregar_metricas_productos(cursor, metricas)
            InformeService._agregar_metricas_ventas(cursor, metricas)
            InformeService._agregar_metricas_clientes(cursor, metricas)
            InformeService._agregar_metricas_produccion(cursor, metricas)
            InformeService._agregar_metricas_devoluciones(cursor, metricas)
            InformeService._agregar_metricas_usuarios(cursor, metricas)
            InformeService._agregar_metricas_categorias(cursor, metricas)

        return metricas

    @staticmethod
    def _agregar_metricas_productos(cursor, metricas):
        try:
            cursor.execute("""
                SELECT
                    COUNT(*),
            ...
            logger.exception("Error métricas Productos")

    @staticmethod
    def _agregar_metricas_ventas(cursor, metricas):
        try:
            ...
            logger.exception("Error métricas Ventas")

    @staticmethod
    def _agregar_metricas_clientes(cursor, metricas):
        try:
            ...
            logger.exception("Error métricas Clientes")

    @staticmethod
    def _agregar_metricas_produccion(cursor, metricas):
        try:
            cursor.execute("""
            ...
            logger.exception("Error métricas Producción")

    @staticmethod
    def _agregar_metricas_devoluciones(cursor, metricas):
        try:
            cursor.execute("""
            ...
            logger.exception("Error métricas Devoluciones")

    @staticmethod
    def _agregar_metricas_usuarios(cursor, metricas):
        try:
            ...
            logger.exception("Error métricas Usuarios")

    @staticmethod
    def _agregar_metricas_categorias(cursor, metricas):
        try:
            ...
            logger.exception("Error métricas Categorías")
